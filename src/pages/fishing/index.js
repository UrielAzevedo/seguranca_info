...
export default () => {
	...
	return(
		<div className={styles.mainContainer}>
			<div className={`${styles.textBox1Tittle} ${styles.tittleAfter}`}>Proteção Contra Phishing  🎣</div>
			...
			<iframe className={styles.videoContainer} width="420" height="345" src="https://www.youtube.com/embed/Ofx1F-Bar_A" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullscreen>
			</iframe>
